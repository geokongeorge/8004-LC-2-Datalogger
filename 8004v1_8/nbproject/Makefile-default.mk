...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../LC8004delay_b.c ../LC8004extFRAM_i.c ../AD5241b.c ../lc8004main_1_8.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/LC8004delay_b.o ${OBJECTDIR}/_ext/1472/LC8004extFRAM_i.o ${OBJECTDIR}/_ext/1472/AD5241b.o ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/LC8004delay_b.o.d ${OBJECTDIR}/_ext/1472/LC8004extFRAM_i.o.d ${OBJECTDIR}/_ext/1472/AD5241b.o.d ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/LC8004delay_b.o ${OBJECTDIR}/_ext/1472/LC8004extFRAM_i.o ${OBJECTDIR}/_ext/1472/AD5241b.o ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o

# Source Files
SOURCEFILES=../LC8004delay_b.c ../LC8004extFRAM_i.c ../AD5241b.c ../lc8004main_1_8.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/lc8004main_1_8.o: ../lc8004main_1_8.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1472" 
	@${RM} ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../lc8004main_1_8.c  -o ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1    -omf=elf -legacy-libc  -mlarge-code -mlarge-data -mlarge-scalar -mconst-in-data -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1472/lc8004main_1_8.o: ../lc8004main_1_8.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../lc8004main_1_8.c  -o ${OBJECTDIR}/_ext/1472/lc8004main_1_8.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d"        -g -omf=elf -legacy-libc  -mlarge-code -mlarge-data -mlarge-scalar -mconst-in-data -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/lc8004main_1_8.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1  -omf=elf -legacy-libc   -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x825 -mreserve=data@0x826:0x84F   -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_REAL_ICE=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -legacy-libc  -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/8004v1_8.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
