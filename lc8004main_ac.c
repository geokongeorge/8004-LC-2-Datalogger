...
//	REVISION:   ac
//	CHECKSUM:	0x5221 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8044/30720   26%
//	PGM(FLASH)MEM:  150840/261888 58%
...
//	Z:\8004\LC8004main_ac.c (main source: x is revision level)
