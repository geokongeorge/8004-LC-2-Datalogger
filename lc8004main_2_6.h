...
#ifndef LC8004main_2_6_H
#define LC8004main_2_6_H
...
//RSN ERROR FLAGS:                                                              REV 2.6
typedef struct{
	unsigned	ch1:1;                                                          //0=NO ERROR, 1=ERROR
	unsigned	ch2:1;
	unsigned	ch3:1;
	unsigned	ch4:1;
	unsigned	ch5:1;
...
typedef union{ unsigned int RSNERROR;
RSN_ERRORBits errorflags;
}RSNERRORflags;
RSNERRORflags    RSN_ERROR1_16;
