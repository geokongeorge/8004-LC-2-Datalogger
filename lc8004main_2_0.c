...
//
//				LC8004
//		Single/4-Channel/8-Channel/16-Channel VW/Thermistor         (4-wire)
//      8-Channel/16-Channel/32-Channel VW                          (2-wire)
//      8-Channel/16-Channel/32-Channel Thermistor                  (2-wire)
//              Datalogger
            ...
            switch (buffer[0]) 
            {
                ...
                case capM:
                    ...
                    if (buffer[1] == capX && buffer[2] == three && buffer[3] == two && buffer[4] == capT && buffer[5] == cr) //Select 32 channel thermistor mux
                    {
                        ...
                        MX32T();                                                
                        putsUART1(MUX32T);                                      //Display 32 Channel TH Mux Selected.   REV 2.0
                        while (BusyUART1());
                        break;
                    }
                    ...
                    if (buffer[1] == capX && buffer[2] == one && buffer[3] == six && buffer[4] == cr) //Select 16 channel mux
                    {
                        ...
                        MX16();                                                 
                        putsUART1(MUX16);                                       //Display 16 Channel VW/TH Mux Selected.
                        while (BusyUART1());
                        break;
                    }
                ...
                case capS:
                    ...
                    if (buffer[1] == cr) //S received
                    {
                        ...
                        if (MUX4_ENABLE.mflags.mux16_4 == TH8) 
                            putsUART1(MUX8T);                                   //REV 2.0
                        if (MUX4_ENABLE.mflags.mux16_4 == TH32) 
                            putsUART1(MUX32T);                                  //REV 2.0
