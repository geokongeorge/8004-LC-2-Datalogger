#ifndef LC8004main_j_H
#define LC8004main_j_H
...
//const float mullith3V=1.4;                              //VER 6.0.2   REM REV J
...
//#define Thermtypeaddress			0x7fe62                                     //REM REV J
...
char _selectGT[]={"Select GageType (1-6) Type 'X' to exit..."};                //REV H
