...
#include "LC8004extFRAM_h.h"                                                    //external FRAM function prototypes
...
long read_longFRAM(unsigned long add)                                           //REV C
{
	...
	temp.e[0]=read_Int_FRAM(add);		//read lower 16 bits of 32 to temp.e[0]
	temp.e[1]=read_Int_FRAM(add+2);	//read upper 16 bits of 32 to temp.e[1]
