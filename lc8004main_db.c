...
//	REVISION:   db
//	CHECKSUM:	0xeeaf  (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8504/30720   28%
//	PGM(FLASH)MEM:  150336/261888 57%
...
float getFrequency(void)
{
	...
	for(i=0;i<loopsTotal;i++)
	{
		...
		if(!IFS0bits.T1IF)                                                      //Capture frequency				
		{
            ...
            //frequency=(VWcount/mS8)*10.0;                                      //convert to frequency	REV DB
