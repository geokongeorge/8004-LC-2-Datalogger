...
//	REVISION:   ab
//	CHECKSUM:	0xa5f2 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8044/30720   26%
//	PGM(FLASH)MEM:  151263/261888 58%
...
//	Z:\8004\LC8004main_ab.c (main source: x is revision level)
//	Z:\8004\LC8004delay_b.c
//	Z:\8004\LC8004extFRAM_e.c
//  Z:\8004\AD5241a.c

//	Header Files:
//#include "p33FJ256GP710A.h"
//#include "LC8004extFRAM_g.h"                              
//#include "LC8004main_ab.h"
...
void displayReading(int ch, unsigned long outputPosition) //display readings stored in external FRAM at FRAMaddress
{
    ...
    {
        //putcUART1(year);                                                      //Binary  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
...
*/
    ...
    {
        //putcUART1(hour);                                                        //Binary  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
    ...
    {
        //putcUART1(minute);                                                      //Binary  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
    ...
    {
        //putcUART1(second);                                                      //Binary  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
    ...
    else                                                                        
    {
        ...
        //putcUART1(MSB);                                                         //mainBat MSB Binary    REV AA    REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(MMSB);                                                        //mainBat MMSB Binary   REV AA    REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(MMMSB);                                                       //mainBat MMMSB Binary  REV AA    REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(LSB);                                                         //mainBat LSB Binary    REV AA    REM REV AB
        //while(BusyUART1());                                                   REM REV AB
    ...
    else                                                                      
    {
        ...
        read_Flt_FRAM(scratchaddress,3);                                        //read back to load MSB,MMSB,MMMSB & LSB    REV AA
        //putcUART1(MSB);                                                         //intThermProcessed MSB Binary    REV AA  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(MMSB);                                                        //intThermProcessed MMSB Binary   REV AA  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(MMMSB);                                                       //intThermProcessed MMMSB Binary  REV AA  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        //putcUART1(LSB);                                                         //intThermProcessed LSB Binary    REV AA  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
        ...
        switch (displayChannel) //VW or 8 or 32 channel Thermistor Display
        {
            ...
            case 1:
                ...
                } else 
                {
                    ...
                    {
                        //putcUART1(MSB);                                         //MSB Binary  REM REV AB
                        //while(BusyUART1());                                   REM REV AB            
                        //putcUART1(MMSB);                                        //MMSB Binary REM REV AB
                        //while(BusyUART1());                                   REM REV AB
                        //putcUART1(MMMSB);                                       //MMMSB Binary    REM REV AB
                        //while(BusyUART1());                                   REM REV AB
                        //putcUART1(LSB);                                         //LSB Binary  REM REV AB
            ...
            case 2:
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while(BusyUART1());
                        putcUART1(MMSB);                                        //MMSB Binary
                        while(BusyUART1());
                        putcUART1(MMMSB);                                       //MMMSB Binary
                        while(BusyUART1());
            ...
            switch (displayChannel) 
            {
                ...
                case 1:
                    ...
                    else
                    {
                        ...
                        {
                            //putcUART1(MSB);                                     //TH MSB Binary   REM REV AB
                            //while(BusyUART1());                               //REM REV AB
                            //putcUART1(MMSB);                                    //TH MMSB Binary  REM REV AB
                            //while(BusyUART1());                               REM REV AB
                            //putcUART1(MMMSB);                                   //TH MMMSB Binary REM REV AB
                            //while(BusyUART1());                               REM REV AB
                            //putcUART1(LSB);                                     //TH LSB Binary   REM REV AB
                ...
                case 2:
                    ...
                    else
                    {
                        ...
                        {
                            putcUART1(MSB);                                     //TH MSB Binary
                            while(BusyUART1());
                            putcUART1(MMSB);                                    //TH MMSB Binary
                            while(BusyUART1());
                            putcUART1(MMMSB);                                   //TH MMMSB Binary
                            while(BusyUART1());
                            putcUART1(LSB);                                     //TH LSB Binary
                        }
                    }
                    break;
    ...
    if (!LC2CONTROL2.flags2.d)                                                  //VER 6.0.2
    {
        if (MUX4_ENABLE.mflags.mux16_4 != TH8 && MUX4_ENABLE.mflags.mux16_4 != TH32 &&
            ...
            putcUART1(comma);                                                   // , DELIMITER
        //sprintf(BUF, "%d", displayArray);                                       //Display the Array # REM REV AB
    ...
    {
        //putcUART1(etx);                                                         //transmit etx char as seperator  REM REV AB
        //while(BusyUART1());                                                   REM REV AB
...
void shutdown(void) 
{
    ...
    //shutdown modules except UART1 & I2C1                                             
...
void storeChannelReading(int ch) {
    ...
    {
        if(ch==1)                                                               //Allow FRAM to wakeup  REV X
        {
