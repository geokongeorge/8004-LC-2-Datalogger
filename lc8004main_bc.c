...
//	REVISION:   bc
//	CHECKSUM:	0x5690 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8386/30720   27%
//	PGM(FLASH)MEM:  146901/261888 56%
        ...
        while (!IFS3bits.T9IF)
        {
            ...
            (channel>=17&&(MUX4_ENABLE.mflags.mux16_4==1)) |        //16 channel
                ...
                case capM:
                    ...
                    //REV BC:
                    if (buffer[1] == capA)                                      //MA received
                    {
                        crlf();
                        putsUART1(ModbusaddressIS);                             //MODBUS address:
                        while (BusyUART1());
                        //READ AND DISPLAY MODBUS ADDRESS FROM FRAM
                        break;
                    }
                    //**********************************************************
