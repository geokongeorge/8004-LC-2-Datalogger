...
//	REVISION:   ah
//	CHECKSUM:	0x8091 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8564/30720   28%
//	PGM(FLASH)MEM:  154134/261888 59%
...
//	Z:\8004\LC8004main_ah.c (main source: x is revision level)
