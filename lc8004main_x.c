...
//	REVISION:   x
//	CHECKSUM:	0x9434 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	7874/30720   26%
//	PGM(FLASH)MEM:  147633/261888 56%
...
//#include "LC8004extFRAM_f.h"                              
//#include "LC8004main_x.h"
...
unsigned long storeReading(int ch) {
    ...
    write_Int_FRAM(FRAMaddress, year);                                          //write 6x to compensate for FRAM wakeup time requirements REV X
    write_Int_FRAM(FRAMaddress, year);                                          //store the year data   
    write_Int_FRAM(FRAMaddress, year);                                          //store the year data   
    write_Int_FRAM(FRAMaddress, year);                                          //store the year data   
    write_Int_FRAM(FRAMaddress, year);                                          //store the year data   
