...
#ifndef LC8004main_db_H
#define LC8004main_db_H
...
//const unsigned int  VAGC_MIN=0x0e66;                                            //2.25V VAGC minimum    REV DB    TEST REM
const unsigned int  VAGC_MIN=0x0100;                                            //TEST    REV DB
