...
//	REVISION:   z
//	CHECKSUM:	0xeec2 (MPLABX ver 3.15 and XC16 ver 1.26)
...
//	Z:\8004\LC8004main_z.c (main source: x is revision level)
...
void displayReading(int ch, unsigned long outputPosition) //display readings stored in external FRAM at FRAMaddress
{
    ...
    for (displayChannel = 1; displayChannel < maxchannelplusone; displayChannel++) {
        ...
        if (MUX4_ENABLE.mflags.mux16_4 == TH8 | MUX4_ENABLE.mflags.mux16_4 == TH32) //8 channel or 32 channel Thermistor mux VER 6.0.9
        {
            ...
            //if(displayChannel==1)                                               //REV V
            //    DEC_TEMP.decimaltemp=read_Int_FRAM(FRAMaddress);                //Dummy read to initialize I2C REV V
            ...
            //if(displayChannel==1)                                               //TEST REV V
            //    Nop();                                                              //TEST REV V
...
void shutdown(void) 
{
    ...
    //shutdown modules except TMR5, UART1 & I2C1:                               // REV E    REM REV Z
    //shutdown modules except UART1 & I2C1:                                     // REV Z
    //PMD1=0x7F5F;                                                                //0111 1111 0101 1111   REM REV Z
    PMD1=0xFF5F;                                                                //1111 1111 0101 1111   REV Z
