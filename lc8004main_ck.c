...
//	REVISION:   ck
//	CHECKSUM:	0x57ab (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8436/30720   27%
//	PGM(FLASH)MEM:  149469/261888 57%
...
//	Z:\8004\LC8004main_ck.c (main source: x is revision level)
                ...
                switch(i)
                {
                    ...
                    case 11:
                        ...
                        if(tempValueValue.status1flags._ST)
                            ...
                            MODBUS_DisableStartTime();                          //REV CK    
                        break;
                    ...
                    case 12:
                        ...
                        if(tempValueValue.status1flags._SP)
                            MODBUS_EnableStopTime();                            //REV CK
                        else
                            MODBUS_DisableStopTime();                           //REV CK
                        break;
...
{
    S_1.status1flags._ST=0;                                                     //clear the MODBUS Start Time status flag    
    write_Int_FRAM(MODBUS_STATUS1address,S_1.status1); 
}
...
void MODBUS_EnableStartTime(void)                                               //REV CK
{
    ...
    LC2CONTROL.flags.Logging = 1;                                               //set the Logging flag
    LC2CONTROL.flags.LoggingStartTime=1;                                        //set the logging start time flag
    ...
    S_1.status1flags._Logging=1;                                                //set the MODBUS Logging flag
    write_Int_FRAM(MODBUS_STATUS1address,S_1.status1);
...
void MODBUS_EnableStopTime(void)                                               //REV CK
{
    ...
    //value=read_Int_FRAM(stopHoursaddress);                                      //get the start hours from FRAM
    //RTChours=value;
    //setClock(RTCAlarm1HoursAddress, RTChours);                                  //load the Start Time Hours into the RTC
...
void READ_TIME(void)                                                            //REV CG
{
    ...
    if(LC2CONTROL2.flags2.Modbus)
    {
        ...
        write_Int_FRAM(RTCMonthsaddress,RTCvalue);                                     //store months in FRAM  
    }
    else
    {
        displayClock(RTCdata);                                                  //display it
    ...
    {
        RTCvalue=RTCdata;                                                       //cast to 16 bit
        write_Int_FRAM(RTCDaysaddress,RTCvalue);                                       //store days in FRAM
    }
    else
    {
        displayClock(RTCdata);                                                  //display it
    ...
    {
        RTCvalue=RTCdata;
        write_Int_FRAM(RTCYearsaddress,RTCvalue);
    }
    else
    {
        displayClock(RTCdata); //display it
    ...
    {
        RTCvalue=RTCdata;
        write_Int_FRAM(RTCHoursaddress,RTCvalue);
    }
    else
    {
        displayClock(RTCdata);                                                  //display it
    ...
    {
        RTCvalue=RTCdata;
        write_Int_FRAM(RTCMinutesaddress,RTCvalue);
    }
    else
    {
        displayClock(RTCdata);                                                  //display it
    ...
    {
        RTCvalue=RTCdata;
        write_Int_FRAM(RTCSecondsaddress,RTCvalue);
    }
    else
    {
        displayClock(RTCdata);                                                  //display it    
...
void stopLogging(void) 
{
    ...
    {                                                                           //REV W
        ...
        LC2CONTROL.flags.Logging = 1; //set the Logging flag	
        LC2CONTROL.flags.LoggingStartTime = 0; //clear the Logging Start Time flag	
        //LC2CONTROL.flags.LoggingStopTime=1;                                   TEST REM REV CI
        LC2CONTROL.flags.LoggingStopTime=0;                                     //TEST REV CI
        write_Int_FRAM(LC2CONTROLflagsaddress,LC2CONTROL.full);	//store flags in FRAM     
