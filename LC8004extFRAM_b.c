...
#include "LC8004extFRAM_b.h"                                                    //external FRAM function prototypes
...
void write_Int_FRAM(unsigned long absAdd, unsigned int data)
{
    ...
    //unsigned int config2=0x10;                              //d64 value for I2C1BRG at 400KHz    REV B    
    unsigned int config2=0x04;                                                  //d64 value for I2CBRG at 1MHz    REV B
    ...
    for(writeloop=0;writeloop<2;writeloop++)
    {
        ...
        selectBank(absAdd,0);                                               //Select the appropriate FRAM   
...
unsigned int read_Int_FRAM(unsigned long absAdd)
{
    ...
    unsigned int config1 = (I2C1_ON & I2C1_IDLE_CON & I2C1_CLK_HLD &
                            ...
                            I2C1_START_DIS);
    //unsigned int config2=0x10;                              //d64 value for I2C1BRG at 400KHz    REV B    
    unsigned int config2=0x04;                              //d64 value for I2C1BRG at 1MHz    REV B    
    //shutdownTimerwithReset(1);									//start the reset timer to reset if hangs   TEST REM REV B
    __builtin_disi(0x3FFF);                                                     //Disable Interrupts    REV B
    OpenI2C1(config1, config2);									//open the I2C1 module
	...
	if(readloop==0)											//data MSB address
		...
		MasterWriteI2C1(tempaddress.y[0]);					//address low byte + 1
            ...
            selectBank(absAdd,1);                                               //select the appropriate FRAM   
    ...
    if(tempdata.ui==0xFFFF && TEST==0)						//if memory is blank	
        return 0;											
...
void write_Flt_FRAM(unsigned long absAdd, float f)
{
    ...
    //unsigned int config2=0x10;                              //d64 value for I2CBRG at 400KHz    REV B
    unsigned int config2=0x04;                              //d64 value for I2C1BRG at 1MHz    REV B    
    //shutdownTimerwithReset(1);									//start the reset timer to reset if hangs   TEST REM REV B
...
void sleepFRAM(void)
{
    ...
    MasterWriteI2C1(0xA0);                                                      //FRAM U2 is the slave device
...
unsigned int testFRAM(unsigned int fram)
{
    ...
    do
    {
        ...
        //tempExtFRAM=0xFFFF;                                                     //TEST REV D    force an error
	...
	switch(fram)						//convert adsadd to float and offset for percentComplete calculation
	{
        ...
        //if(percentComplete>=0.0 && percentComplete<5.0)                       //REM REV B
        if(percentComplete==0.0)                                                //REV B
        {
            putcUART1(zero);
            putcUART1(0x0D);                                                    //<CR>  REV B
        }
        //if(percentComplete>=5.0 && percentComplete<10.0)                      //REM REV B
        if(percentComplete==5.0)                                                //REV B
        {
            putcUART1(five);
            putcUART1(0x0D);                                                    //<CR>  REV B
        }
        //if(percentComplete>=10.0 && percentComplete<15.0)                     //REM REV B
        ...
        //if(percentComplete>=15.0 && percentComplete<20.0)                     //REM REV B
        ...
        //if(percentComplete>=20.0 && percentComplete<25.0)                     //REM REV B
        ...
        //if(percentComplete>=25.0 && percentComplete<30.0)                     //REM REV B
        ...
        //if(percentComplete>=30.0 && percentComplete<35.0)                     //REM REV B
        ...
        //if(percentComplete>=35.0 && percentComplete<40.0)                     //REM REV B
        ...
        //if(percentComplete>=40.0 && percentComplete<45.0)                     //REM REV B
        ...
        //if(percentComplete>=45.0 && percentComplete<50.0)                     //REM REV B
        ...
        //if(percentComplete>=50.0 && percentComplete<55.0)                     //REM REV B
        ...
        //if(percentComplete>=55.0 && percentComplete<60.0)                     //REM REV B
        ...
        //if(percentComplete>=60.0 && percentComplete<65.0)                     //REM REV B
        ...
        //if(percentComplete>=65.0 && percentComplete<70.0)                     //REM REV B
        ...
        //if(percentComplete>=70.0 && percentComplete<75.0)                     //REM REV B
        ...
        //if(percentComplete>=75.0 && percentComplete<80.0)                     //REM REV B
        ...
        //if(percentComplete>=80.0 && percentComplete<85.0)                     //REM REV B
        ...
        //if(percentComplete>=85.0 && percentComplete<90.0)                     //REM REV B
        ...
        //if(percentComplete>=90.0 && percentComplete<95.0)                     //REM REV B
        ...
        //if(percentComplete>=95.0 && percentComplete<99.9)                     //REM REV B
        ...
        //if(percentComplete>99.9)                                              //REM REV B
	...
	//putcUART1(0x0D);								//<CR>                      //REM REV B
	//while(BusyUART1());                                                       //REM REV B
