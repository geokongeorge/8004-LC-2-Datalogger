...
//	REVISION:   p
//	CHECKSUM:	0x2bef (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	7962/30720   26%
//	PGM(FLASH)MEM:  147405/261888 56%
...
float getFrequency(void)
{
	...
	for(i=0;i<loopsTotal;i++)
	{
		...
		if(!IFS0bits.T1IF)                                                      //Capture frequency				
		{
            ...
            //VWcount=VWcountLSW*8;                                               //compensate for 1:8 prescaler    REM REV O
