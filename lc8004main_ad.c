...
//	REVISION:   ad
//	CHECKSUM:	0x2e2d (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8162/30720   27%
//	PGM(FLASH)MEM:  151338/261888 58%
...
//	Z:\8004\LC8004main_ad.c (main source: x is revision level)
...
void shutdown(void) 
{
    ...
    //if(BT_CONNECT)                                                              //if Bluetooth connected    REV AD
      //  _BT_RESET=0;                                                             //Reset the Bluetooth module    REV AD
