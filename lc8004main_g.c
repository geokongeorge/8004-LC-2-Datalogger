...
//	REVISION:   g
//	CHECKSUM:	0x9417 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	7314/30720   24%
//	PGM(FLASH)MEM:  134730/261888 51%
...
void _3VX_on(void) 
{
    ...
    write_AD5241(gain);                                                         //set initial front-end gain    REV F
}
                        ...
                        while (testmenuBUF[0] != capX) 
                        {
                            ...
                            switch (testmenuBUF[0]) //perform the test
                            {
                                ...
                                case five:                                      //REV G
                                    ...
                                    RxDataTemp = ReadUART1();                   //get the char from the UART buffer to clear it
                                    disableLPF();                               //turn off the LPF CLOCK
                                    _3VX_off();                                 //power-down the analog circuitry
                                    putcUART1(0x0D);                            //<CR>
                                    while (BusyUART1());
                                    putsUART1(Poweroff);                        //display "Analog power supplies off"
                            ...
                            if (RxData == 0) {
                                delay(160000); //a little aesthetic delay       //REV F
