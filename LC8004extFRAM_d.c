...
#include "LC8004extFRAM_d.h"                                                    //external FRAM function prototypes
...
char TEST=0;
//unsigned int config2=0x06;                                                      //d64 value for I2C1BRG at 800KHz    REV D   
unsigned int config2=0x10;                                                      //d64 value for I2C1BRG at 400KHz    REV D    
//******************************************************************************
//                              displayError
//
...
unsigned int read_Int_FRAM(unsigned long absAdd)
{
    ...
    //testPoint(1,1);
    write_Int_FRAM(absAdd, tempdata.ui);                                        //Refresh   REV D
...
void read_Flt_FRAM(unsigned long absAdd, unsigned int x)
{
    ...
    //testPoint(1,2);
    write_Flt_FRAM(absAdd, tempdata.g);                                         //Refresh memory    REV D
    //StopshutdownTimer();							//stop the reset timer
