#ifndef LC8004main_g_H
#define LC8004main_g_H
...
unsigned char gain=0x80;                                                        //initial gain value (Av=500, Rf=499K)  REV F
...
//PortE Defines
//#define E                       LATEbits.LATE0      //LPF Fco Select control                (OUTPUT)  REM REV G
//#define F                       LATEbits.LATE1      //LPF Fco Select control                (OUTPUT)  REM REV G
//#define G                       LATEbits.LATE2      //LPF Fco Select control                (OUTPUT)  REM REV G
//#define H                       LATEbits.LATE3      //LPF Fco Select control                (OUTPUT)  REM REV G
...
void enableLPF(unsigned char gageType);                                         //REV G
