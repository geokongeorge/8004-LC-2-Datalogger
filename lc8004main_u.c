...
//	REVISION:   u
//	CHECKSUM:	0x9c48 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	7872/30720   26%
//	PGM(FLASH)MEM:  146757/261888 56%
...
//                                  Include LC8004extFRAM_d.h, .c which refreshes FRAM after each read
//
//
//
//
...
//#include "LC8004extFRAM_d.h"                              
//#include "LC8004main_u.h"
...
void displayReading(int ch, unsigned long outputPosition) //display readings stored in external FRAM at FRAMaddress
{
    ...
    for (displayChannel = 1; displayChannel < maxchannelplusone; displayChannel++) {
        ...
        {
            //extThermreading = read_Int_FRAM(FRAMaddress);                     REM REV U
            //extThermRaw = ((Vref * extThermreading) / 4096); //convert to voltage REM REV U
            //extThermProcessed = V_HT2C(extThermRaw,ch); //convert to degrees C     //REM REV U
...
void resetMemory(void) 
{
    ...
    data = 0; //reset memory pointers                                         //TEST REM REV U
    //data=3639;                                                                  //TEST REV U
    write_Int_FRAM(MemoryStatusaddress,data);                                   
    write_Int_FRAM(Offsetaddress,data);    

    data = 1;                                                                 //TEST REM REV U
    //data=3640;                                                                  //TEST REV U
