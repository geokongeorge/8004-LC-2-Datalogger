...
//	REVISION:   ci
//	CHECKSUM:	0x2843 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	8438/30720   27%
//	PGM(FLASH)MEM:  148773/261888 57%
...
//	Z:\8004\LC8004main_ci.c (main source: x is revision level)
