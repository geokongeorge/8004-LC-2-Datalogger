...
//	REVISION:   e
//	CHECKSUM:	0x43d2 (MPLABX ver 3.15 and XC16 ver 1.26)
//	DATA(RAM)MEM:	7366/30720   24%
//	PGM(FLASH)MEM:  134046/261888 51%
                    ...
                    if (buffer[1] == capE && buffer[2] == capS && buffer[3] == capT) //TEST<CR> received
                    {
                        ...
                        while (testmenuBUF[0] != capX) 
                        {
                            ...
                            switch (testmenuBUF[0]) //perform the test
                            {
                                ...
                                case four:                                      //Test 1KHz 5V Excitation    VER E
                                    crlf();
                                    putsUART1(_5VEXCON);                        //display "5V Excitation on."
                                    while (BusyUART1());   
                                    ...
                                    putcUART1(0x0D);                            //<CR>
                                    while (BusyUART1());
                                    putsUART1(_5VEXCOFF);                       //display "5V Excitation off."
                                    while (BusyUART1());
                                    RxData = 0;
                                    break;
                                    
                                case five:                                      //Test 1KHz 12V Excitation    VER E
                                    crlf();
                                    putsUART1(_12VEXCON);                       //display "12V Excitation on."
                                    while (BusyUART1());   
                                    ...
                                    putcUART1(0x0D);                            //<CR>
                                    while (BusyUART1());
                                    putsUART1(_12VEXCOFF);                       //display "12V Excitation off."
                                    while (BusyUART1());
                                    RxData = 0;
                                    break;
...
void displayTestMenu(void) {
    ...
    putsUART1(TM4); //      4         +3V EXCITATION
    while (BusyUART1());
    crlf();

    putsUART1(TM5); //      5         +12V EXCITATION
    while (BusyUART1());
    crlf();
